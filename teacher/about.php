...
<html lang="en">
    ...
    <head>
        ...
        <title>Teacher Name - About | Apna Sikshalaya</title>
  ...
  <div class="wrapper">
     ...
     <div class="col-md-12">
         ...
         <div class="anav-title wow fadeIn" data-wow-delay="0.1s">Teacher Name</div>

           <div class="anav-title2"> - graphics designer -  </div>
            ...
            <div class="anav-div">
                ...
                <ul class="anav-ul">
                    ...
                    <li>
                       ...
                       <a draggable="false" href="about.php">About</a>

                    </li>

                    <li>

                       <a draggable="false" href="career.php">Career</a>
         ...
         <div class="margin-about">
             ...
             <div class="box-about col-md-4 col-xs-offset-1">
               ...
               <h3 class="heading-inner">About</h3>
                  ...
                  <div class="hr"></div>
                    ...
                    <span class="text-about">Lorem ipsum dolor sit amet,</span>  consectetur adipiscing elit. Morbi ipsum tellus, tristique eu molestie at, maximus ut leo. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.
                    ...
                    <span class="text-about">Lorem ipsum dolor sit amet,</span>  consectetur adipiscing elit. Morbi ipsum tellus, tristique eu molestie at, maximus ut leo. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.</h4>

                    <h4>

                    <span class="text-about">Lorem ipsum dolor sit amet, consecterus adipiscing.</span></h4>               
             ...
             <div class="col-md-6 wow fadeIn" data-wow-delay="0.1s">
               ...
               <img draggable="false" src="img/about1.jpg" alt="" class="photo-about"/> 
         ...
         <!-- Start right image -->
             ...
             <div class="col-md-6 wow fadeIn col-md-offset-1" data-wow-delay="0.1s">
               ...
               <img draggable="false" src="img/about.jpg" alt="" class="photo-about"/> 
