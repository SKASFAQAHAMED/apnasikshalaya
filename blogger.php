    ...
    <main class="squish">
        ...
        <section class="container-fluid">
            ...
            <div class="site-background" data-aos="fade-up" data-aos-delay="100">
                <h3 style="color:white;">Apnasikshalaya</h3>
                <h1>...Blogs posted by our Students</h1>
                <button class="arrow-btn"><a href="#blog">Explore Our Blogs</a></button>
            </div>
            </div>
        </section>
                    ...
                    <div class="owl-carousel owl-theme blog-post">
                        <div class="blog-content" data-aos="fade-in" data-aos-delay="200">
                            ...
                            <div class="blog-title">
                               ...
                               <a href="#" style="color: rgba(255, 86, 0, 1);">Read More</a>
            ...
            <div class="site-content">
                <div class="posts">
                    ...
                    <div class="post-content" data-aos="fade-in" data-aos-delay="200">
                        <div class="post-image">
                            <div>
                                <img draggable="false" src="./assets/Blog-post/blog2.png" class="img" alt="blog1">
                            </div>
                            <div class="post-info flex-row">
                                <span><i class="fas fa-user text-gray"></i>&nbsp;&nbsp;Admin</span>
                                <span><i class="fas fa-calendar-alt text-gray"></i>&nbsp;&nbsp;August, 6 2021</span>
                        ...
                        <div class="post-title">
                            <a draggable="false" href="#">Why should boys have all the fun? it's the women who are making india an
                                alcohol-loving contry</a>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque voluptas deserunt beatae
                                adipisci iusto totam placeat corrupti ipsum, tempora magnam incidunt aperiam tenetur a
                                nobis, voluptate, numquam architecto fugit. Eligendi quidem ipsam ducimus minus magni
                    ...
                    <div class="post-content" data-aos="fade-in" data-aos-delay="200">
                        <div class="post-image">
                            <div>
                                <img draggable="false" src="./assets/Blog-post/blog3.png" class="img" alt="blog1">
                            </div>
                            <div class="post-info flex-row">
                                <span><i class="fas fa-user text-gray"></i>&nbsp;&nbsp;Admin</span>
                                <span><i class="fas fa-calendar-alt text-gray"></i>&nbsp;&nbsp;August, 6 2021</span>
                    ...
                    <div class="post-content" data-aos="fade-in" data-aos-delay="200">
                        <div class="post-image">
                            <div>
                                <img draggable="false" src="./assets/Blog-post/blog4.png" class="img" alt="blog1">
                            </div>
                            <div class="post-info flex-row">
                                <span><i class="fas fa-user text-gray"></i>&nbsp;&nbsp;Admin</span>
                                <span><i class="fas fa-calendar-alt text-gray"></i>&nbsp;&nbsp;August, 6 2021</span>
